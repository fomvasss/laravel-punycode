...
use Fomvasss\Punycode\Exception\DomainOutOfBoundsException;
use Fomvasss\Punycode\Exception\LabelOutOfBoundsException;
...
class Punycode
{
    ...
    /**
     * Punycode constructor.
     */
    public function __construct()
    {
        $this->config = config('punycode');
